defmodule Rumbl.VideoControllerTest do
	...
	test "lists all user's videos on index", %{conn: conn, user: user} do
		...
		other_video = insert_video(insert_user(username: "others"), title: "another video")
    ...
    count_before = video_count(Video)+1
    conn = post conn, video_path(conn, :create), video: @invalid_attrs
		assert html_response(conn, 302) == "<html><body>You are being <a href=\"/manage/videos\">redirected</a>.</body></html>"
